...
function Subscribed({ id }) {
  ...
  const classIfMyProfile =
    "overflow-y-clip font-bold w-[256px] leading-4 text-[1.2rem] py-2";
  const classIfNotMyProfile =
    "overflow-y-clip font-bold w-fit leading-4 text-[1.2rem] py-2";

  return (
    <div className="w-full mt-4">
      <h2 className="text-center mb-4 text-2xl font-bold text-gray-900">
        Subscribed Users
      </h2>
      <div className="w-full overflow-auto p-2 max-h-[690px]">
        {subscribed.length === 0 && (
          <p className="text-center">Subscribe to others, bitch!</p>
        )}
